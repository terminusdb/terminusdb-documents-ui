...
function getProperties(fullFrame, current, frame, uiFrame, mode, formData, onTraverse, onSelect, documentation) {
  ...
  for (var item in frame) {
    ...
    if (item === "@key") continue;else if (item === "@type") continue;else if (item === "@subdocument") continue;else if (item === _constants.DOCUMENTATION) {
      ...
      var _frames4 = (0, _choiceSubDocumentTypeFrames.makeChoiceSubDocumentTypeFrames)(fullFrame, current, frame, item, uiFrame, mode, formData, onTraverse, onSelect);
      ...
      var pointFrames = (0, _subDocumentTypeFrames.makeSubDocumentFrames)(subDocumentFrame, item, uiFrame, mode, formData, onTraverse, onSelect); //set properties and ui
      ...
      var geoFrame = (0, _geoFrames.makeGeoFrames)(newGeoFrame, item, uiFrame, mode, formData); //set properties and ui
