...
function FrameViewer(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    setSchema(schema);
    var uiSchema = properties.uiSchema; // get form level ui schema 
    ...
    if (uiFrame && uiFrame.hasOwnProperty("ui:description")) uiSchema["ui:description"] = uiFrame["ui:description"]; // order is set to place @documentation field at the start of the document
  ...
  var submitButtonCss = "btn-info";

  if (uiFrame && Object.keys(uiFrame).length && uiFrame.hasOwnProperty(_constants.SUBMIT_BUTTON_STYLE_KEY)) {
    submitButtonCss = uiFrame[_constants.SUBMIT_BUTTON_STYLE_KEY];
  }
