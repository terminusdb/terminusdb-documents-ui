...
exports.makeListData = makeListData;
exports.makeListDocuments = makeListDocuments;
exports.makeListSubDocuments = makeListSubDocuments;
...
function makeListSubDocuments(setFrames, item, uiFrame, mode, formData, onTraverse) {
  var properties = {},
      propertiesUI = {};
  ...
  var layout = {
    ...
    items: [{
      ...
      required: (0, _utils.getRequiredForListSubDocs)(setFrames.properties[item]["properties"])
    }]
  };
...
function makeListData(listFrames, item, uiFrame, mode, formData) {
  var properties = {},
      propertiesUI = {};
  var layout = {
    type: "array",
  ...
  if (mode !== _constants.CREATE && formData.hasOwnProperty(item)) {
    var filledItems = [];
    var subFrames = (0, _utils.removeDefaultsFromDataFrame)(listFrames.properties[item]["properties"]);
    var count = 0,
...
function makeListDocuments(listFrames, item, uiFrame, mode, formData, onTraverse) {
  var properties = {},
      propertiesUI = {};
  var layout = {
    type: "array",
  ...
  if (mode !== _constants.CREATE && formData.hasOwnProperty(item)) {
    var filledItems = [];
    var defaultValues = listFrames.properties[item]["default"];
  ...
  if (mode !== _constants.VIEW && listFrames.uiSchema[item] && listFrames.uiSchema[item]["ui:field"]) {
    listFrames.uiSchema[item]["ui:field"] = _utils.getOptionalSelect;
  }
