...
function getDocumentLayout(documentClass, fullFrame, current, item, uiFrame, mode, formData, onTraverse, onSelect) {
  ...
  var exractedProperties = (0, _FrameHelpers.getProperties)(fullFrame, current, frame, uiFrame, mode, filledData, onTraverse, onSelect); //console.log("exractedProperties", exractedProperties)
...
function getCreateUILayout(frame, item, layout, uiFrame) {
...
function getEditUILayout(frame, item, layout, uiFrame) {
  var subDocuemntBg = (0, _utils.extractUIFrameSubDocumentTemplate)(uiFrame) ? (0, _utils.extractUIFrameSubDocumentTemplate)(uiFrame) : 'bg-secondary';
  var uiLayout = {
    "ui:title": (0, _utils.getTitle)(item, (0, _utils.checkIfKey)(item, frame["@key"])),
...
function getViewLayout(fullFrame, current, frame, item, uiFrame, mode, formData, onTraverse, onSelect) {
  ...
  if ((0, _utils.isFilled)(formData, item)) {
    ...
    layout["description"] = "Choose ".concat(item, " from the list ...");
  }
...
function getViewUILayout(frame, item, layout, uiFrame) {
