...
// example [125.6, 10.1]
function pointType(frame, item, uiFrame, mode, formData) {
  var _layout;
  ...
  if (mode !== _constants.VIEW) {
    ...
    //ui
    var uiProperties = (0, _pointTypeFrames.getPointTypeCreateEditUI)(item);
    propertiesUI[item] = uiProperties[item];
  } else {
    //view
    var _uiProperties = (0, _pointTypeFrames.getPointTypeViewUI)(formData, item);
