...
import {DEMO_SCHEMA, CURRENT, CURRENT_DATA, SESHAT_SCHEMA_FULL_REPLACED_TEST, SESHAT_SCHEMA_FULL, SESHAT_SCHEMA_SMALL, SMALL_SCHEMA, SMALL_SCHEMA_FORM_DATA, SESHAT_FORM_DATA, SESHAT_SCHEMA, NUCLEAR_SCHEMA, NUCLEAR_FORM_DATA, PROFILE_FORM_DATA, PROFILE_SCHEMA, PROFILE_FORM_DATA_USER, DEMO_FORM_DATA, DEMO_SCHEMA_UI, DEMO_DOCUMENT_TYPE, CREATE} from "./sample"

const App= (props) =>{

    const [schema, setSchema]=useState(CURRENT) //schema
    ...
    const [formData, setFormData]=useState(CURRENT_DATA) // formdata => required only on edit/ view
