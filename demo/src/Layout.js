...
import {DEMO_SCHEMA, SMALL_SCHEMA, SMALL_SCHEMA_FORM_DATA, SESHAT_FORM_DATA, SESHAT_SCHEMA, NUCLEAR_SCHEMA, NUCLEAR_FORM_DATA, PROFILE_FORM_DATA, PROFILE_SCHEMA, PROFILE_FORM_DATA_USER, DEMO_FORM_DATA, DEMO_SCHEMA_UI, DEMO_DOCUMENT_TYPE, CREATE} from "./sample"

const App= (props) =>{

    const [schema, setSchema]=useState(SESHAT_SCHEMA) //schema
